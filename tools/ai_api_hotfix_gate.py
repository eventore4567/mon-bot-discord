...
def main() -> None:
    assert FAST_MODEL_FALLBACK == "gpt-5.6-luna"
    assert BALANCED_MODEL_FALLBACK == "gpt-5.6-terra"
    assert ADVANCED_MODEL_FALLBACK == "gpt-5.6-sol"
    assert IMAGE_MODEL_FALLBACK == "gpt-image-2"
    ...
    for bad in ("gpt-5-mini", "gpt-5.1", "gpt-5-pro", "gpt-image-1"):
