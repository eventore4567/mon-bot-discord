...
anti-nuke, rollback rôles, incidents, sauvegardes auto et onglet dashboard.
"""
...
def main() -> None:
    ...
    print("OK: Security V2 — compteur, rollback, incidents, backups, commandes et dashboard branchés")
