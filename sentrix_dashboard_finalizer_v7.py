...
def install() -> bool:
    ...
    # V24 is strictly visual and runs after V23 so every button generated by V12/V18/V23
    # receives the same semantic intent colors and interaction states without changing behavior.
