...
.card:hover,.media-grid img:hover{{border-color:#43506b;box-shadow:0 18px 48px rgba(0,0,0,.26)}}
.public-pointer{{position:fixed;z-index:99;width:11px;height:11px;border-radius:50%;pointer-events:none;opacity:0;transform:translate(-50%,-50%);background:#a897ff44;box-shadow:0 0 32px #7667ff66;transition:opacity .15s ease}}
