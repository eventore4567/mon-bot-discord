...
async function renderGames() {
  if (state.sub === 'acces') state.sub = 'jeux';
  else if (state.sub === 'avance') state.sub = 'jeux';
  else state.sub = 'jeux';
  await renderEconomy();
}
