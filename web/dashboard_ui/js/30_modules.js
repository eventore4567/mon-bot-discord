...
async function renderVerification() {
  ...
  const paint = () => { $('verifyPreview').innerHTML = discordMessage({ embed: { title: $('verifyTitle').value || 'Vérification', description: $('verifyRules').value || 'Votre règlement apparaîtra ici.', image: $('verifyImage').value, color: '#5865f2' } }); };
