...
async function renderTickets() {
  ...
  if (!panels.length && !state.ticketCreate) {
    content().innerHTML = `<div class="grid">${head}${emptyState('Vous n’avez pas encore configuré vos tickets', 'Créez un premier panneau : les membres cliqueront dessus pour ouvrir un ticket.', { id: 'ticketCreate', label: 'Créer mon premier panneau' })}</div>`;
    bindModuleButtons();
