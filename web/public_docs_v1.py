...
*{box-sizing:border-box}html{scroll-behavior:smooth;background:var(--bg)}body{margin:0;color:var(--text);font:14px/1.6 ui-sans-serif,system-ui,-apple-system,"Segoe UI",Inter,sans-serif;background:radial-gradient(900px 620px at 84% -10%,rgba(77,163,255,.13),transparent 64%),linear-gradient(180deg,var(--bg),#0c1015 52%,var(--bg));-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}button,input{font:inherit;color:inherit}:focus-visible{outline:2px solid var(--blue2);outline-offset:2px}.wrap{width:min(1260px,calc(100% - 36px));margin:auto}
