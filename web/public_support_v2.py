...
header{position:sticky;top:0;z-index:100;border-bottom:1px solid rgba(255,255,255,.055);background:rgba(6,7,11,.82);backdrop-filter:blur(14px)}
.nav{height:72px;display:flex;align-items:center;justify-content:space-between;gap:22px}.brand{display:flex;align-items:center;gap:10px;font-size:18px;font-weight:950;letter-spacing:-.03em}.brand img{width:39px;height:39px;border-radius:12px;border:1px solid rgba(255,255,255,.12)}.links{display:flex;gap:6px;align-items:center}.links a{padding:9px 10px;border-radius:9px;color:var(--muted);font-size:12px;font-weight:800}.links a:hover{background:rgba(255,255,255,.05);color:#fff}.menu-toggle{display:none;width:42px;height:42px;border:1px solid var(--line);border-radius:11px;background:#101720;color:#fff;cursor:pointer}.menu-toggle i{display:block;width:18px;height:2px;margin:4px auto;border-radius:99px;background:currentColor}
.btn{position:relative;display:inline-flex;align-items:center;justify-content:center;min-height:43px;padding:10px 15px;border:1px solid var(--line);border-radius:11px;background:#121924;color:#fff;font-weight:850;font-size:12px;overflow:hidden;transition:.18s ease}.btn:before{content:"";position:absolute;inset:0;background:linear-gradient(105deg,transparent 25%,rgba(255,255,255,.10),transparent 75%);transform:translateX(-130%);transition:.5s ease}.btn:hover{transform:translateY(-2px);border-color:#41516c;box-shadow:0 14px 38px rgba(0,0,0,.25)}.btn:hover:before{transform:translateX(130%)}.btn.primary{border-color:transparent;background:linear-gradient(135deg,#4da3ff,#3d8fe6 60%,#77bcff);box-shadow:0 14px 38px rgba(111,97,247,.28)}
.hero{position:relative;min-height:560px;display:grid;grid-template-columns:.9fr 1.1fr;gap:54px;align-items:center;padding:72px 0 56px}.hero:before{content:"";position:absolute;left:50%;top:-230px;width:900px;height:650px;transform:translateX(-50%);border-radius:50%;background:radial-gradient(circle,rgba(77,163,255,.10),transparent 68%);filter:blur(30px);animation:breath 12s ease-in-out infinite alternate}.hero-copy{position:relative;z-index:3}.badge{display:inline-flex;align-items:center;gap:8px;padding:7px 10px;border:1px solid rgba(119,188,255,.25);border-radius:999px;background:rgba(77,163,255,.08);color:#c8e5ff;font-size:10px;font-weight:950;letter-spacing:.1em;text-transform:uppercase}.badge i{width:7px;height:7px;border-radius:50%;background:var(--green);box-shadow:0 0 16px rgba(89,221,160,.8);animation:pulse 1.8s ease-in-out infinite}.hero h1{margin:18px 0;font-size:clamp(45px,6vw,74px);line-height:.97;letter-spacing:-.06em}.hero h1 span{background:linear-gradient(110deg,#fff,#c7c0ff 50%,#77bfff);-webkit-background-clip:text;background-clip:text;color:transparent}.hero p{max-width:650px;margin:0;color:var(--muted);font-size:17px;line-height:1.72}.actions{display:flex;flex-wrap:wrap;gap:9px;margin-top:26px}
.support-visual{position:relative;min-height:420px;perspective:1200px}.orb{position:absolute;inset:58px;border:1px solid rgba(77,163,255,.055);border-radius:50%;opacity:.55;animation:spin 34s linear infinite}.orb:before,.orb:after{content:"";position:absolute;width:9px;height:9px;border-radius:50%;background:var(--violet2);box-shadow:0 0 20px rgba(119,188,255,.85)}.orb:before{left:12%;top:18%}.orb:after{right:9%;bottom:20%;background:var(--blue)}
.support-console{position:absolute;inset:20px 20px 20px 26px;padding:20px;border:1px solid rgba(255,255,255,.12);border-radius:22px;background:linear-gradient(145deg,rgba(18,24,35,.97),rgba(8,12,18,.99));box-shadow:0 30px 78px rgba(0,0,0,.44);transform:rotateY(-2deg) rotateX(1deg);animation:float 10s ease-in-out infinite}.console-head{display:flex;align-items:center;justify-content:space-between;padding-bottom:15px;border-bottom:1px solid var(--line)}.console-head b{font-size:13px}.live{display:inline-flex;align-items:center;gap:7px;color:#8de2b7;font-size:8px;font-weight:900}.live i{width:6px;height:6px;border-radius:50%;background:var(--green)}.support-flow{display:grid;gap:10px;margin-top:18px}.flow{display:grid;grid-template-columns:39px 1fr auto;gap:10px;align-items:center;padding:11px;border:1px solid var(--line);border-radius:11px;background:#0a0f16}.flow i{width:36px;height:36px;border-radius:10px;background:rgba(77,163,255,.12);display:grid;place-items:center;color:#b9ddff;font-style:normal;font-size:8px;font-weight:950}.flow b{display:block;font-size:9px}.flow small{display:block;color:var(--muted);font-size:7px}.flow em{font-style:normal;color:#8de2b7;font-size:7px;font-weight:900}.typing{display:flex;gap:5px;margin-top:18px}.typing i{width:6px;height:6px;border-radius:50%;background:var(--violet);animation:typing 1.3s ease-in-out infinite}.typing i:nth-child(2){animation-delay:.15s}.typing i:nth-child(3){animation-delay:.30s}
.section{padding:108px 0}.section h2{margin:8px 0 0;font-size:clamp(31px,4vw,49px);line-height:1.05;letter-spacing:-.045em}.eyebrow{color:var(--violet2);font-size:10px;font-weight:950;letter-spacing:.11em;text-transform:uppercase}.lead2{max-width:700px;color:var(--muted);line-height:1.72}
.cards{display:grid;grid-template-columns:repeat(2,1fr);gap:18px;margin-top:38px}.support-card{--cx:50%;--cy:50%;position:relative;overflow:hidden;min-height:190px;padding:22px;border:1px solid var(--line);border-radius:18px;background:rgba(13,18,26,.94);transform-style:preserve-3d;will-change:transform;transition:border-color .18s ease,box-shadow .18s ease,transform .16s ease}.support-card:before{content:"";position:absolute;inset:0;pointer-events:none;background:radial-gradient(260px circle at var(--cx) var(--cy),rgba(77,163,255,.07),transparent 66%);opacity:0;transition:opacity .2s}.support-card:hover{border-color:#344155;box-shadow:0 18px 42px rgba(0,0,0,.22)}.support-card:hover:before{opacity:1}.support-card>*{position:relative;transform:translateZ(10px)}.support-card .icon{width:42px;height:42px;border-radius:12px;border:1px solid var(--line);background:#172030;display:grid;place-items:center;color:#c7e5ff;font-size:9px;font-weight:950}.support-card h3{margin:16px 0 7px}.support-card p{margin:0;color:var(--muted);font-size:12px;line-height:1.65}
.smart-assistant{margin-top:46px;padding:28px;border:1px solid var(--line);border-radius:20px;background:#0b1017;box-shadow:0 20px 55px rgba(0,0,0,.22)}
...
.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:11px;margin-top:22px}.field{display:grid;gap:7px}.field.full{grid-column:1/-1}.field label{font-size:9px;font-weight:900;color:var(--soft);text-transform:uppercase;letter-spacing:.07em}.field input,.field select,.field textarea{width:100%;border:1px solid var(--line);border-radius:10px;background:#070c12;color:#fff;padding:11px 12px;font:inherit;font-size:12px;outline:none;transition:border-color .16s ease,box-shadow .16s ease}.field textarea{min-height:92px;resize:vertical}.field input:focus,.field select:focus,.field textarea:focus{border-color:rgba(77,163,255,.65);box-shadow:0 0 0 3px rgba(77,163,255,.10)}.field small{color:var(--muted);font-size:8px}
...
if(!reduced){
  ...
  function aim(el,x,y,max,scale=1){const r=el.getBoundingClientRect(),nx=Math.max(0,Math.min(1,(x-r.left)/r.width))-.5,ny=Math.max(0,Math.min(1,(y-r.top)/r.height))-.5,s=state(el);s.trx=-ny*max*scale;s.try=nx*max*scale;s.ttx=nx*6*scale;s.tty=ny*4*scale;el.style.setProperty("--cx",((nx+.5)*100)+"%");el.style.setProperty("--cy",((ny+.5)*100)+"%");if(!s.raf)s.raf=requestAnimationFrame(()=>animate(el))}
  function release(el){const s=state(el);s.trx=s.try=s.ttx=s.tty=0;if(!s.raf)s.raf=requestAnimationFrame(()=>animate(el))}
  all(".support-card,.diag-panel,.smart-assistant,.score-card,.report-card").forEach(el=>{const max=el.classList.contains("support-card")?4.8:3;el.addEventListener("pointermove",e=>{if(e.pointerType!=="touch")aim(el,e.clientX,e.clientY,max)});el.addEventListener("pointerleave",()=>release(el));el.addEventListener("pointerdown",e=>{if(e.pointerType==="touch"){aim(el,e.clientX,e.clientY,max,.75);setTimeout(()=>release(el),220)}})});
  const visual=$("#supportVisual");visual?.addEventListener("pointermove",e=>{if(e.pointerType!=="touch")aim(visual,e.clientX,e.clientY,2.8)});visual?.addEventListener("pointerleave",()=>release(visual));visual?.addEventListener("pointerdown",e=>{if(e.pointerType==="touch"){aim(visual,e.clientX,e.clientY,4,.7);setTimeout(()=>release(visual),220)}});
}
