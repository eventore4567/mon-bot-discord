...
.sx-ticket-editor-backdrop{position:fixed;inset:0;z-index:10000;display:grid;place-items:center;padding:24px;background:rgba(4,7,12,.76);backdrop-filter:blur(4px)}
.sx-ticket-editor{width:min(920px,100%);max-height:min(90vh,940px);display:flex;flex-direction:column;border:1px solid #39435a;border-radius:15px;background:#0b1019;box-shadow:0 24px 80px rgba(0,0,0,.55);overflow:hidden}
.sx-ticket-editor-head{display:flex;justify-content:space-between;gap:14px;align-items:center;padding:15px 17px;border-bottom:1px solid #252d3e}.sx-ticket-editor-head h4{margin:0;font-size:16px;color:#f0edf5}.sx-ticket-editor-head p{margin:4px 0 0;color:#8b95a7;font-size:10px}
.sx-editor-body{padding:15px;display:grid;gap:11px;overflow:auto}
.sx-editor-section{border:1px solid #273044;border-radius:11px;background:#0f151f;overflow:visible}.sx-editor-section>summary{cursor:pointer;list-style:none;padding:12px 13px;color:#e5e2eb;font-size:11px;font-weight:850}.sx-editor-section>summary::-webkit-details-marker{display:none}.sx-editor-section>summary::after{content:"+";float:right;color:#8a94a7;font-size:15px;line-height:12px}.sx-editor-section[open]>summary::after{content:"–"}.sx-editor-section-body{padding:0 13px 13px;display:grid;gap:11px}
.sx-editor-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.sx-editor-grid .full{grid-column:1/-1}.sx-editor-field label{display:block;margin:0 0 5px;color:#b8c0ce;font-size:10px;font-weight:800}.sx-editor-field small{display:block;margin-top:4px;color:#7d8799;font-size:9px;line-height:1.4}.sx-editor-field input,.sx-editor-field textarea,.sx-editor-field select{width:100%;box-sizing:border-box;background:#111824;color:#eae8ef;border:1px solid #2c3548;border-radius:9px;padding:9px 10px;font:inherit;font-size:11px}.sx-editor-field textarea{min-height:82px;resize:vertical}
.sx-editor-note{padding:9px 10px;border:1px solid #2b3448;border-radius:9px;background:#111722;color:#98a2b4;font-size:10px;line-height:1.5}

.sx-role-picker{position:relative}.sx-role-picker-top{display:flex;align-items:center;justify-content:space-between;gap:10px}.sx-role-picker-title b{display:block;color:#c3cad6;font-size:10px}.sx-role-picker-title span{display:block;margin-top:3px;color:#7f899b;font-size:9px;line-height:1.4}.sx-role-picker-button{min-height:35px;max-width:270px;padding:0 11px;border:1px solid #354057;border-radius:9px;background:#151c28;color:#e3e0e9;font-size:10px;font-weight:800;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.sx-role-popover{margin-top:8px;border:1px solid #354057;border-radius:10px;background:#0b111b;padding:10px;box-shadow:0 12px 35px rgba(0,0,0,.35)}.sx-role-popover.sx-hidden{display:none}.sx-role-search{width:100%;box-sizing:border-box;margin-bottom:7px;background:#111824;color:#eeeaf4;border:1px solid #2f394e;border-radius:8px;padding:9px 10px;font-size:10px}.sx-role-list{max-height:220px;overflow:auto;display:grid;gap:3px}.sx-role-option{display:flex;align-items:center;gap:8px;padding:8px 9px;border-radius:8px;color:#c9cfda;font-size:10px;cursor:pointer}.sx-role-option:hover{background:#151d2a}.sx-role-option input{width:auto;margin:0}.sx-role-option.sx-filtered{display:none}.sx-role-footer{display:flex;justify-content:flex-end;gap:7px;margin-top:8px;padding-top:8px;border-top:1px solid #222b3d}.sx-role-footer button{min-height:31px;padding:0 10px;border:1px solid #354057;border-radius:8px;background:#151c28;color:#d9d6df;font-size:9px;font-weight:800;cursor:pointer}.sx-role-footer .done{background:#6651c3;border-color:#745ed3;color:#fff}
.sx-selected-roles{display:flex;gap:5px;flex-wrap:wrap;margin-top:7px}.sx-selected-role{padding:4px 7px;border:1px solid #33415a;border-radius:999px;background:#151d2a;color:#aeb9ca;font-size:9px}.sx-selected-role.more{color:#8d97a9}

.sx-type-wrap{display:grid;gap:9px}.sx-type-card{border:1px solid #293246;border-radius:10px;background:#0d131d;overflow:visible}.sx-type-card>summary{display:flex;align-items:center;justify-content:space-between;gap:10px;cursor:pointer;list-style:none;padding:11px 12px}.sx-type-card>summary::-webkit-details-marker{display:none}.sx-type-card>summary b{display:block;color:#e7e4ed;font-size:11px}.sx-type-card>summary span{display:block;margin-top:3px;color:#768195;font-size:9px}.sx-type-card>summary em{font-style:normal;color:#8e98aa;font-size:9px}.sx-type-body{padding:0 12px 12px;display:grid;gap:10px}.sx-type-advanced{border-top:1px solid #222b3c;padding-top:4px}.sx-type-advanced>summary{cursor:pointer;color:#8792a5;font-size:9px;font-weight:800;padding:6px 0}.sx-inherit-row{display:flex!important;align-items:center;gap:8px;padding:9px 10px;border:1px solid #2b3549;border-radius:9px;background:#111824;color:#bdc5d3!important;font-size:10px!important;cursor:pointer}.sx-inherit-row input{width:auto!important;margin:0}.sx-type-role-overrides.sx-hidden{display:none}.sx-mini-danger{justify-self:start;border:1px solid #64343b;background:#26161a;color:#efa3ac;border-radius:8px;padding:6px 9px;font-size:9px;cursor:pointer}
.sx-editor-add{min-height:34px;padding:0 11px;border:1px solid #6550bd;border-radius:9px;background:#211b39;color:#cdbfff;font-size:10px;font-weight:800;cursor:pointer}
.sx-editor-footer{display:flex;justify-content:flex-end;gap:8px;padding:12px 15px;border-top:1px solid #252d3e;background:#0d121b}.sx-editor-footer button{min-height:37px;padding:0 14px;border-radius:9px;border:1px solid #343d52;background:#171d29;color:#e5e2ea;font-weight:800;font-size:10px;cursor:pointer}.sx-editor-footer button:disabled{opacity:.65;cursor:wait}.sx-editor-footer .save{background:#6f57d4;border-color:#7e65e7;color:#fff}.sx-editor-footer .delete{margin-right:auto;background:#2b171b;border-color:#69343d;color:#f1a2aa}
...
function closeEditor(){editingId=null;editorTypes=[];deletedTypeIds=[];$("sxEditorBackdrop")?.remove();render()}
...
async function savePanel(){captureTypes();const saveButton=$("sxSavePanel");if(saveButton){saveButton.disabled=true;saveButton.textContent="Enregistrement…"}const payload={name:$("sxPanelName").value,title:$("sxPanelTitle").value,description:$("sxPanelDescription").value,color:$("sxPanelColor").value,image_url:$("sxPanelImage").value,thumbnail_url:$("sxPanelThumbnail").value,footer_text:$("sxPanelFooter").value,style:$("sxPanelStyle").value,max_per_member:Number($("sxPanelMax").value),enabled:$("sxPanelEnabled").value==="1",access_role_ids:pickerValues("panel-access"),ping_role_ids:pickerValues("panel-ping"),deleted_type_ids:deletedTypeIds,types:editorTypes.map((t,i)=>({id:t.id||null,name:t.name,description:t.description,emoji:t.emoji,button_label:t.button_label,button_style:t.button_style,open_message:t.open_message,staff_role_id:t.staff_role_id||null,position:Number(t.position??i),inherit_roles:Boolean(t.inherit_roles),access_role_ids:t.access_role_ids||[],ping_role_ids:t.ping_role_ids||[]}))};try{const b=await api(`/api/guilds/${guildId()}/ticket-center/panels/${editingId}`,{method:"PATCH",headers:{"Content-Type":"application/json","X-CSRF-Token":csrf()},body:JSON.stringify(payload)});toast35(b.message||"Panel enregistré.");editingId=null;editorTypes=[];deletedTypeIds=[];$("sxEditorBackdrop")?.remove();data=null;await load(guildId(),true)}catch(e){toast35(e.message,true);if(saveButton&&document.body.contains(saveButton)){saveButton.disabled=false;saveButton.textContent="Enregistrer"}}}
async function deletePanel(){const p=data?.panels?.find(x=>String(x.id)===String(editingId));if(!p||!confirm(`Supprimer le panel « ${p.name} » ? Les tickets déjà ouverts ne seront pas supprimés.`))return;try{const b=await api(`/api/guilds/${guildId()}/ticket-center/panels/${editingId}`,{method:"DELETE",headers:{"X-CSRF-Token":csrf()}});toast35(b.message||"Panel supprimé.");editingId=null;editorTypes=[];deletedTypeIds=[];$("sxEditorBackdrop")?.remove();data=null;await load(guildId(),true)}catch(e){toast35(e.message,true)}}
