"""Point d'entrée Railway SentriX V98/V99/V100/V101/V102/V103.
...
la surface slash, simplifie les noms visibles et fiabilise les playlists. V103 remet
``/setup`` sur son contrôleur natif après toutes les couches de compatibilité, puis V98
construit l'arborescence finale et le bootstrap Railway historique prend le relais.
"""
