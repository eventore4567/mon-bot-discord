...
PUBLIC_COMMANDS = frozenset({
    ...
    "scramble", "wordgame", "emojiquiz", "colorquiz", "fasttype", "minesweeper", "duel",
    ...
    "hunt", "explore", "bomb", "target", "archery", "ghost", "sequence", "lava", "rocket", "safe", "dragon", "zombie", "ice", "potion", "race", "detective", "crown", "collec", "gamehistory", "gameprofile", "gamestats", "gametop",
    "dailygames",
